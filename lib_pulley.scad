...
hole_tolerance = 10.0 / 9.50;
teeth = 80;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
motor_shaft_small = 5.3 * hole_tolerance;	// NEMA17 motor shaft exact diameter = 5
motor_shaft_large = 12.7 * hole_tolerance;

gt2_pulley(74, motor_shaft_small);
//translate([60, 0, 0]) gt2_pulley(80, motor_shaft_large);

// tuneable constants

module gt2_pulley(teeth, motor_shaft) {
    ...
    m3_dia = 3.2 * hole_tolerance;		// 3mm hole diameter
    ...
    pulley_b_ht = 2 * pulley_t_ht;		// pulley base height, standard = 8. Set to same as idler_ht if you want an idler but no pulley.
